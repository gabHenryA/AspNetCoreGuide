...
namespace StockTests.ControllerTests
{
    public class StocksControllerTest
    {
        ...
        public async Task Explore_StockIsNull_ShouldReturnExploreViewWithStocksList()
        {
            ...
            List<Dictionary<string, string>>? stocksDict = Newtonsoft.Json.JsonConvert.DeserializeObject<List<Dictionary<string, string>>>(@"[
            ...
            viewResult.ViewData.Model.Should().BeEquivalentTo(expectedStocks);//Arrange
        }
    }
}
